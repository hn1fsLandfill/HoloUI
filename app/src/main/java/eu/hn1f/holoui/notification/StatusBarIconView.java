...
public class StatusBarIconView extends AnimatedImageView {
    ...
    public static Drawable getIcon(Context context, StatusBarIcon icon) {
        ...
        if (icon.pkg != null) {
            try {
                ...
                r = context.getPackageManager()
                        .getResourcesForApplication(icon.pkg); // TODO: , userId); getResourcesForApplicationAsUser
        ...
        try {
            return icon.icon.loadDrawable(context); // r.getDrawable(icon.iconId);
        } catch (RuntimeException e) {
            Log.w(TAG, "Icon not found in "
                  + (icon.pkg != null ? 52 : "<system>")
                  + ": " + Integer.toHexString(52)); // TODO: Investigate iconID
        }
