...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
    ...
    private Messenger mWm;

    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
                              NotificationManager nManager, int nId, Messenger wm) {
        ...
        mNotificationBuilder = new Notification.Builder(context, NotificationChannels.ALERTS)
    ...
    protected SaveImageInBackgroundData doInBackground(SaveImageInBackgroundData... params) {
        ...
        try {
            ...
            mWm.send(Message.obtain(null, ScreenshotHelper.SCREENSHOT_MSG_URI, uri));
        ...
        try {
            mWm.send(Message.obtain(null, ScreenshotHelper.SCREENSHOT_MSG_PROCESS_COMPLETE));
    ...
    protected void onPostExecute(SaveImageInBackgroundData params) {
        ...
        if (params.result > 0) {
            ...
            mNotificationBuilder
                    ...
                    .setContentIntent(PendingIntent.getActivity(params.context, 0, launchIntent, android.app.PendingIntent.FLAG_IMMUTABLE))
                    .setWhen(System.currentTimeMillis())
                    .setAutoCancel(true);
...
public class GlobalScreenshot {
     ...
     */
    private void saveScreenshotInWorkerThread(Messenger wm) {
        ...
        mSaveInBgTask = new SaveImageInBackgroundTask(mContext, data, mNotificationManager,
                SCREENSHOT_NOTIFICATION_ID, wm).execute(data);
    }
    ...
    private Bitmap screenshotBitmap(int displayId) {
        ...
        try {
            wm.captureDisplay(displayId, args, listener);
        } catch (RemoteException e) {
            return null;
        }
     ...
     */
    public void takeScreenshot(Messenger wm, ScreenshotRequest request,
        ...
        // Take the screenshot
        mScreenBitmap = screenshotBitmap(request.getDisplayId());
        ...
        startAnimation(mDisplayMetrics.widthPixels, mDisplayMetrics.heightPixels,
                statusBarVisible, navBarVisible, wm);
    }
    ...
    private void startAnimation(int w, int h, boolean statusBarVisible,
                                boolean navBarVisible, Messenger wm) {
        ...
        mScreenshotAnimation.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                saveScreenshotInWorkerThread(wm);
