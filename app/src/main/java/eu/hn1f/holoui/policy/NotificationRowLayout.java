...
import eu.hn1f.holoui.ExpandHelper;
import eu.hn1f.holoui.R;
import eu.hn1f.holoui.SwipeHelper;
import eu.hn1f.holoui.notification.OnSizeChangedListener;
    ...
    public void setLayoutTransitionsEnabled(boolean b) {
        if (b) {
            ...
            if (mRealLayoutTransition.isRunning()) {
                try {
                    mRealLayoutTransition.getClass().getMethod("cancel").invoke(mRealLayoutTransition);
