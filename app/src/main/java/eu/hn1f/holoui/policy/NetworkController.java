...
import eu.hn1f.holoui.DemoMode;
...
public class NetworkController extends BroadcastReceiver implements DemoMode {
    ...
    private int mBluetoothTetherIconId =
            R.drawable.stat_sys_tether_bluetooth;
    ...
    public NetworkController(Context context) {
        ...
        mHasMobileDataFeature = true; /* cm.isNetworkSupported(ConnectivityManager.TYPE_MOBILE); */
        ...
        Messenger wifiMessenger = null; // mWifiManager.getWifiServiceMessenger();
    ...
    // dex2jar is funny shit
    // so lets roll our own dirty ass hack
    public int invokeHiddenIntStuff(Object obj, String fun) {
        try {
            return (int) obj.getClass().getMethod(fun).invoke(obj);
        } catch (IllegalAccessException | NoSuchMethodException | InvocationTargetException e) {
            return 0;
        }
    }
    public boolean invokeHiddenBoolStuff(Object obj, String fun) {
        try {
            return (boolean) obj.getClass().getMethod(fun).invoke(obj);
        } catch (IllegalAccessException | NoSuchMethodException | InvocationTargetException e) {
            return false;
        }
    }
    ...
    public boolean isEmergencyOnly() {
        return (mServiceState != null && invokeHiddenBoolStuff(mServiceState,"isEmergencyOnly"));
    }
    ...
    void notifySignalsChangedCallbacks(NetworkSignalChangedCallback cb) {
        ...
        boolean wifiIn = wifiEnabled && mWifiSsid != null
                && (mWifiActivity == 0x03 // WifiManager.DATA_ACTIVITY_INOUT
                || mWifiActivity == 0x01 /* WifiManager.DATA_ACTIVITY_IN */);
    ...
    private boolean hasService() {
        if (mServiceState != null) {
            ...
            switch(invokeHiddenIntStuff(mServiceState,"getVoiceRegState")) {
                case ServiceState.STATE_POWER_OFF:
                    return false;
                case ServiceState.STATE_OUT_OF_SERVICE:
                case ServiceState.STATE_EMERGENCY_ONLY:
                    return invokeHiddenIntStuff(mServiceState,"getDataRegState") == ServiceState.STATE_IN_SERVICE;
                default:
                    return true;
            }
        } else {
        ...
        if (!hasService()) {
            ...
            if (mSignalStrength == null) {
                ...
                if (isCdma() && mAlwaysShowCdmaRssi) {
                    try {
                        mLastSignalLevel = (int) mSignalStrength.getClass().getMethod("getCdmaLevel")
                                .invoke(mSignalStrength);
        ...
        if (mIsWimaxEnabled && mWimaxConnected) {
            ...
            switch (mDataNetType) {
                ...
                case TelephonyManager.NETWORK_TYPE_NR:
                    ...
                    mDataTypeIconId = R.drawable.stat_sys_data_fully_connected_5g;
    ...
    void refreshViews() {
        ...
        if (mAirplaneMode &&
                (mServiceState == null || (!hasService() && !isEmergencyOnly()))) {
