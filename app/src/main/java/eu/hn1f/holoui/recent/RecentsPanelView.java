...
public class RecentsPanelView extends FrameLayout implements OnItemClickListener, RecentsCallback, Animator.AnimatorListener {
    ...
    protected int getFadeHeight(boolean offsetRequired) {
        ...
        return getBottom() - getTop() - getPaddingBottom() - padding;
    }
    ...
    private void showImpl(boolean show) {
        sendCloseSystemWindows(getContext(), "recentsapp");
    ...
    public void handleSwipe(View view) {
        ...
        // the task.
        final ActivityTaskManager am = (ActivityTaskManager)
                getContext().getSystemService("activity_task" /* Context.ACTIVITY_TASK_SERVICE */);
        if (am != null) {
