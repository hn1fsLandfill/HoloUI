...
import eu.hn1f.holoui.RecentsComponent;

public class Recents implements RecentsComponent {
    private static final String TAG = "Recents";
    private static final boolean DEBUG = false;
    private Context mContext = null;
    private int USER_CURRENT = -2;

    public Recents(final Context newContext) {
        mContext = newContext;
    }
    ...
    public void toggleRecents(Display display, int layoutDirection, View statusBarView) {
        ...
        try {
            ...
            intent.setClassName("eu.hn1f.holoui",
                    "eu.hn1f.holoui.recent.RecentsActivity");
    ...
    public void preloadRecentTasksList() {
        ...
        intent.setClassName("eu.hn1f.holoui",
                "eu.hn1f.holoui.recent.RecentsPreloadReceiver");
        mContext.sendBroadcastAsUser(intent, UserHandle.getUserHandleForUid(USER_CURRENT));
