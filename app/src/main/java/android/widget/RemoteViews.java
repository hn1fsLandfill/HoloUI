...
public class RemoteViews implements Parcelable, Filter {
    ...
    public static class RemoteResponse {
        ...
        private static RemoteResponse fromPendingIntentTemplateAndFillInIntent(
                final PendingIntent pendingIntent, final Intent intent) {
            RemoteResponse response = new RemoteResponse();
         ...
         */
        public RemoteResponse addSharedElement(int viewId,
    ...
    public interface InteractionHandler {
         ...
         * @hide
         */
        default void onScroll(AbsListView view) {}
    }
